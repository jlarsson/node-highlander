(function (module) {
    ...
    var Klass = function (options) {
        ...
        this.options = _.defaults({}, options, {
            resolveMissingCommandHandler: throwMissingHandler
        });
        this.commands = {};
    };
    ...
    proto.getCommandHandler = function (ctx) {
        ...
        return (this.commands[ctx.command] || normalizeHandler(this.options.resolveMissingCommandHandler(ctx))) || throwMissingHandler(ctx);
    };
